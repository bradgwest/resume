  ...
  \resumeSubHeadingListStart
    \resumeSubheadingSmall
      ...
      \resumeItemListStart
        ...
        \resumeItemLean{Designed and implemented a Continuous Integration/Continuous Deployment (CI/CD) system for all of dbt Labs' cloud infrastructure. Reduced infrastructure engineers' manual toil ($>$30\%/hr) by automatically detecting and concurrently deploying updates to hundreds of customer environments on Azure and AWS. Crucial system for supporting dbt Labs' rapid multi-cloud feature growth.}
      \resumeItemListEnd
